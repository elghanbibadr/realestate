        ...
        <div className=" flex  justify-evenly w-1/2 ">
          <div>
            ...
            <ul>
              ...
              <li>
                {" "}
                تواصل معنا على <b className="text-cyan">Contact@SoumAqar.sa</b>
              </li>
            </ul>
            <div className="flex items-center  mt-6 justify-between w-1/2">
              <a
                target="_blank"
                href="https://www.tiktok.com/@soumaqar?_t=8gG4hSEYDNh&_r=1"
              >
                <img src={tiktok} alt="twitter icon" />
              </a>
              <a
                target="_blank"
                href="https://instagram.com/soumaqar?igshid=MzRlODBiNWFlZA=="
              >
                <img src={instagram} alt="twitter icon" />
              </a>
              <a
                target="_blank"
                href="https://x.com/soumaqar?s=21&t=3FI4TtL_IYnC6NntJvy8Rw"
              >
