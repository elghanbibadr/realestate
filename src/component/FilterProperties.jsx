...
const mapDispatchToProps = (dispatch) => ({
    onUpdateFilterPropertiesInfo: (payload) => dispatch({ type: FILTER_PROPERTIES_CHANGE_SELECTED_SPAN, payload }),
});
...
class FilterProperties extends Component{
  ...
  handleClick(value){
    this.props.onUpdateFilterPropertiesInfo({
      selectedSpan: value
    });
  }
      ...
      return (
        <div className="max-w-[330px] text-right    bg-[#EDF2F7] rounded-md  h-fit mt-20">
          <ul className="flex bg-white mb-6   border-[#ccc] border-b   justify-around rounded-t-lg  flex-row-reverse  font-bold text-[18px] text-right">
            <li className="text-[#808080] dinNextLtRegular cursor-pointer py-4 ">
              {" "}
              للتأجير{" "}
            </li>
            <li className="text-darkBlue dinNextLtRegular border-darkBlue py-4 px-10 border-b-2 cursor-pointer">
              {" "}
              للشراء{" "}
            </li>
          </ul>
          <div className="p-4 ">
            <div className="text-darkBlue dinNextLtBold ">
              ...
              <div className="flex cursor-pointer text-[14px]  rounded-md mx-auto bg-white flex-row-reverse">
                <span
                  className={`py-2 w-full text-center px-6 ${
                    selectedSpan === 0 ? "bg-darkBlue rounded-md text-white" : ""
                  }`}
                ...
                <span
                  className={`py-2 w-full text-center px-6 ${
                    selectedSpan === 2 ? "bg-darkBlue rounded-md text-white" : ""
                  }`}
            ...
            <div className="p-0 mt-6">
              ...
              />
              <Label className="mt-6" text="الحي" />
              <Select
                options={[
                  "الأزهار (Al-Azhaar)",
                  "البديعة (Al-Badia)",
              ...
              <div className="mb-2 flex mt-4 items-center flex-row-reverse">
                ...
                <p className="text-[16px] mx-2  text-darkBlue dinNextLtRegular">
                  {" "}
                  بحت متقدم{" "}
                </p>
              </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(FilterProperties);