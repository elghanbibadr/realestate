  ...
  return (
    <div className="rightDir p-10">
       ...
       <h5 className="cyanTitle text-[24px]">ابحت عن عقارك </h5>
         ...
         <h4 className="dinNextLtRegular text-[18px]"> تقدر تشوف العقارات الموجودة في كل منطقة </h4>
   </div>
    <div className=" bg-[#EDF2F7] p-10 rounded-md">
   <div className="mt-10 w-fit relative flex mb-4">
    <img src={arrowWhiteBg} alt="arrpw with white background" />
            <Input className="text-right  filterProprtyInput  pl-20 pr-8  mx-3 border-white dinNextLtRegular" placeholder="حي النرجس، الرياض " />

            <img className="absolute right-[68px] top-[19px]" src={searchnormal} alt="search icon " />
            </div>
    ...
    }} zoom={13} center={center} mapContainerClassName="map-container">
            <Marker position={center} />
          </GoogleMap>
                <div className="h-fit ">
          <div className="flex justify-between items-center  p-4">
            <div>
              <p className="text-textColor text-[18px] dinNextLtRegular">650+ عقار</p>
              <h3 className="text-[#3E4958] text-[27px] font-semibold dinNextLtRegular">عقارات النرجس</h3>
            </div>
