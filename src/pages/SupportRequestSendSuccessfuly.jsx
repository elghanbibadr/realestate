...
<div className="dinNextLtBold p-4 mt-6 pr-10 rightDir">
   ...
   <img className="h-[80%]  self-end justify-self-end" src={emailSent} alt="property added" />
   <div className="justify-self-center">
    <h2 className="text-darkBlue text-right text-[42px] dinNextLtBold"> تم ارسال طلبك لنا بنجاح
</h2>
